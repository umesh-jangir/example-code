...
function commercekit_ajax_remove_wishlist() {
	...
	$ajax['status'] = 1;
	$ajax['html']   = '<a href="#wishlists" class="commercekit-save-wishlist" data-product-id="' . $pid . '" data-type="list" title="' . esc_html__( 'Wishlist', 'commercegurus-commercekit' ) . '" aria-label="' . esc_html__( 'Wishlist', 'commercegurus-commercekit' ) . '"><em class="cg-wishlist"></em><span></span></a>';
...
function commercekit_single_product_wishlist() {
	...
	if ( $commercekit_wishlist ) {
		...
		if ( $wid ) {
			...
			$wsl_page      = isset( $commercekit_options['wsl_page'] ) ? esc_attr( $commercekit_options['wsl_page'] ) : 0;
			$wsl_page_link = get_permalink( $wsl_page );
			$html          = '<div class="commercekit-wishlist"><a href="' . $wsl_page_link . '" class="commercekit-browse-wishlist" title="' . esc_html__( 'Wishlist', 'commercegurus-commercekit' ) . '" aria-label="' . esc_html__( 'Wishlist', 'commercegurus-commercekit' ) . '"><em class="cg-wishlist"></em><span>' . $wsl_brtext . '</span></a></div>';
		} else {
			$wsl_adtext = isset( $commercekit_options['wsl_adtext'] ) && ! empty( $commercekit_options['wsl_adtext'] ) ? commercekit_get_multilingual_string( stripslashes_deep( $commercekit_options['wsl_adtext'] ) ) : commercekit_get_default_settings( 'wsl_adtext' );
			$html       = '<div class="commercekit-wishlist"><a href="#" class="commercekit-save-wishlist" data-product-id="' . $pid . '" data-type="page" title="' . esc_html__( 'Wishlist', 'commercegurus-commercekit' ) . '" aria-label="' . esc_html__( 'Wishlist', 'commercegurus-commercekit' ) . '"><em class="cg-wishlist"></em><span>' . $wsl_adtext . '</span></a></div>';
		}
...
function commercekit_after_shop_loop_item_wishlist() {
	...
	if ( $commercekit_wishlist ) {
		...
		if ( $wid ) {
			$html = '<div class="commercekit-wishlist mini"><a href="' . $wsl_page_link . '" class="commercekit-browse-wishlist" title="' . esc_html__( 'Wishlist', 'commercegurus-commercekit' ) . '" aria-label="' . esc_html__( 'Wishlist', 'commercegurus-commercekit' ) . '"><em class="cg-wishlist-t"></em><span></span></a></div>';
		} else {
			$html = '<div class="commercekit-wishlist mini"><a href="#" class="commercekit-save-wishlist" data-product-id="' . $pid . '" data-type="list" title="' . esc_html__( 'Wishlist', 'commercegurus-commercekit' ) . '" aria-label="' . esc_html__( 'Wishlist', 'commercegurus-commercekit' ) . '"><em class="cg-wishlist"></em><span></span></a></div>';
		}
